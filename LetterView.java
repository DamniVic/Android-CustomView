package com.hskj.damnicomniplusvic.wevenation.costumview;

/**
 * Created by DAMNICOMNIPLUSVIC on 2017/7/29.
...
public class LetterView extends View {
     ...
     * #>选中的字母颜色
     */
    public static final int TEXT_COLOR_SELECTED = 0xffa3a3a3;
    /**
     * 没有触碰状态下的字母颜色
     */
    ...
    private void init() {
        ...
        paint.setTextSize(getResources().getDimension(R.dimen.text_12sp));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (width == 0 || height == 0) {
            width = getWidth();
            height = getHeight();
            abcHeight = height / (1+letters.length());
        }
