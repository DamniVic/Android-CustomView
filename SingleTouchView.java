package com.hskj.damnicomniplusvic.nnnn.costumview;

/**
 * Created by DAMNICOMNIPLUSVIC on 2017/3/20.
...
import com.hskj.damnicomniplusvic.nnnn.R;
 ...
 *
 */
public class SingleTouchView extends android.support.v7.widget.AppCompatImageView {
    /**
     * 图片的最大缩放比例
     */
    ...
    private void init(){
        ...
        if(controlDrawable == null){
            controlDrawable = getContext().getResources().getDrawable(R.drawable.rotating);
        }
        ...
        switch (event.getAction() ) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mStatus == STATUS_ROTATE_ZOOM) {
                    ...
                    //图片某个点到图片中心的距离
                    float bitmapToCenterDistance = (float) Math.sqrt(((float)halfBitmapWidth )* halfBitmapWidth + halfBitmapHeight * halfBitmapHeight);
